...
<head>
  ...
  <title>Selamat Datang di UndangTeman.id</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .header{background:linear-gradient(135deg,#1C2B4A 0%,#2D3F6B 100%);padding:36px 32px;text-align:center}
    .header-icon{font-size:36px;margin-bottom:8px}
    .header h1{color:#fff;font-size:22px;font-weight:600;letter-spacing:.02em}
  ...
  <div class="wrap">
    <div class="card">
      <div class="header">
        ...
        <p>Portal Undangan Digital</p>
      </div>
      <div class="body">
        <p class="greeting">Halo, {{ $user->full_name }} 👋</p>
        <p class="text">
          Selamat datang! Akun Anda berhasil dibuat di UndangTeman.id.
        ...
        <div class="warning">
          🔒 Demi keamanan, segera ubah password Anda setelah berhasil login pertama kali.
        </div>

        <p class="text">
          Dengan UndangTeman.id, undangan pernikahan Anda bisa jadi hari ini juga —
          tanpa antri admin, tanpa biaya revisi, sebar langsung ke seluruh tamu.
        </p>
      </div>
      <div class="footer">
        ...
        <p style="margin-top:8px;font-size:11px;color:#aaa">
          Abaikan email ini jika Anda tidak mendaftar di UndangTeman.id.
        </p>
      </div>
    </div>
  </div>
